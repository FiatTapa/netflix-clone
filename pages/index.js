      ...
      <div className="h-full w-full relative">
        ...
        {showCommentBox && (
          <div className="absolute z-10 right-20 flex top-20 w-60 md:w-15rem bg-[#00000077] flex-col px-4 py-6">
            <h1 className="text-sm font-sans font-bold text-white">Comments...</h1>
            <ul id="comment-container" className="flex flex-col mt-4 h-60 overflow-auto scrollbar-none">
              {allComments.map((comment, index) => (
                <li className={`flex flex-col w-full ${index !== 0 ? 'mt-2' : ''}`} key={index}>
